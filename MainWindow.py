...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(520, 0, 525, 731))
...
"}")
        ...
        self.label_2.setMinimumSize(QtCore.QSize(0, 235))
        ...
        self.toolButton_4 = QtWidgets.QToolButton(self.frame_14)
        font = QtGui.QFont()
        font.setFamily("FontAwesome")
        self.toolButton_4.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("src/../assets/play_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButton_4.setIcon(icon)
        self.toolButton_4.setObjectName("toolButton_4")
        self.horizontalLayout_7.addWidget(self.toolButton_4)
        self.toolButton = QtWidgets.QToolButton(self.frame_14)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("src/../assets/pause_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolButton_4.setText(_translate("MainWindow", "/f04b"))
        self.toolButton.setText(_translate("MainWindow", "..."))
        self.horizontalSlider.setToolTip(_translate("MainWindow", "Utliser <- et -> pour plus de précision"))
        self.label_7.setText(_translate("MainWindow", "40 s"))
